...
from Web_Trauma_Motality.Input_Function import define_model, eval_model_DNN
...
class Trauma_MotalityForm(Form):
    ...
    Intentionality = SelectField('Intentionality', choices=[('0', '1: accidental, unintentional'), ('1', '2: self-harm, suicide'), ('2', '3: violence, assault'), ('3', '4: other specified'), ('4', '5: unspecified')])
    Damagemechanism = SelectField('Damage mechanism', choices=[('0', '1: traffic accident-car'), ('1', '2: traffic accident-bike'), ('2', '3: traffic accident-motorcycle'), ('3', '4: traffic accident-etc.'), ('4', '5: traffic accident-unspecified'), ('5', '6: fall'), ('6', '7: slip down'), ('7', '8: struck'), ('8', '9: firearm/cut/pierce'), ('9', '10: machine'), ('10', '11: fire, flames or heat'), ('11', '12: drowning or nearly'), ('12', '13: poisoning'), ('13', '14: choking, hanging'), ('14', '15: etc.'), ('15', '16: unknown')])
    Emergencysymptoms = SelectField('Emergency symptoms', choices=[('0', 'Yes'), ('1', 'No'), ('2', 'Unknown')])
    Reactionafterhospitalized = SelectField('Reaction after hospitalized', choices=[('0', 'Alert'), ('1', 'Verbal response(drowsy)'), ('2', 'Painful response(semicoma)'), ('3', 'Unresponsive(coma)'), ('4', 'Unknown')])
    Initialseveritytriageresult = SelectField('Initial severity triage result', choices=[('0', '1: Level 1(Resuscitation)'), ('1', '2: Level 2(Emergency)'), ('2', '3: Level 3(Urgency)'), ('3', '4: Level 4(Less urgency)'), ('4', '5: Level 5(Nonurgency)'), ('5', '6: unknown')])
    Changedseveritytriageresult = SelectField('Changed severity triage result', choices=[('0', '1: Level 1(Resuscitation)'), ('1', '2: Level 2(Emergency)'), ('2', '3: Level 3(Urgency)'), ('3', '4: Level 4(Less urgency)'), ('4', '5: Level 5(Nonurgency)')])
    Torsosurgerychest = SelectField('Torso surgery chest', choices=[('0', 'No'), ('1', 'Yes')])
    Torsosurgeryabdomen = SelectField('Torso surgery abdomen', choices=[('0', 'No'), ('1', 'Yes')])
    Torsosurgeryvascular = SelectField('Torso surgery vascular', choices=[('0', 'No'), ('1', 'Yes')])
    Torsosurgeryheart = SelectField('Torso surgery heart', choices=[('0', 'No'), ('1', 'Yes')])
    Headsurgery = SelectField('Head surgery', choices=[('0', 'No'), ('1', 'Yes')])
    Ecmo = SelectField('Ecmo', choices=[('0', 'No'), ('1', 'Yes')])
    ICD = StringField("Three-digit ICD-10 code", description="ex)S072, T083")
...
def method_evaluation(input_eval_data):
    SavePath = './Web_Trauma_Motality/DNN/'
    ...
    survive_rate = round(prob_dnn * 100, 4)
    deceased_rate = 100 - survive_rate
...
def send_list_values(Age, Gender, Intentionality, Damagemechanism, Emergencysymptoms, Reactionafterhospitalized, Initialseveritytriageresult, Changedseveritytriageresult, ICD):
    ...
    list_Intentionality = ['1: accidental, unintentional', '2: self-harm, suicide', '3: violence, assault', '4: other specified', '5: unspecified']
    send_Intentionality = list_Intentionality[int(Intentionality)]

    list_Damagemechanism = ['1: traffic accident-car', '2: traffic accident-bike', '3: traffic accident-motorcycle', '4: traffic accident-etc.', '5: traffic accident-unspecified', '6: fall', '7: slip down', '8: struck', '9: firearm/cut/pierce', '10: machine', '11: fire, flames or heat', '12: drowning or nearly', '13: poisoning', '14: choking, hanging', '15: etc.', '16: unknown']
    ...
    list_Initialseveritytriageresult = ['1: Level 1(Resuscitation)', '2: Level 2(Emergency)', '3: Level 3(Urgency)', '4: Level 4(Less urgency)', '5: Level 5(Nonurgency)', '6: unknown']
    send_Initialseveritytriageresult = list_Initialseveritytriageresult[int(Initialseveritytriageresult)]

    list_Changedseveritytriageresult = ['1: Level 1(Resuscitation)', '2: Level 2(Emergency)', '3: Level 3(Urgency)', '4: Level 4(Less urgency)', '5: Level 5(Nonurgency)']
...
def processTrauma_MotalityForm(request):
    form = Trauma_MotalityForm(request.form)
    return form

def processTrauma_MotalityResult(request):
    ...
    onehot_Intentionality = function_one_hot_encoding(Intentionality, arrSize=5)
    Damagemechanism = request.form['Damagemechanism']
    onehot_Damagemechanism = function_one_hot_encoding(Damagemechanism, arrSize=16)
    ...
    onehot_Initialseveritytriageresult = function_one_hot_encoding(Initialseveritytriageresult, arrSize=6)
    Changedseveritytriageresult = request.form['Changedseveritytriageresult']
    onehot_Changedseveritytriageresult = function_one_hot_encoding(Changedseveritytriageresult, arrSize=5)
